...
9.  A Kafka message bus to transport message
...
change to the docker-compose directory in your chapter 8 source code.  Issue the following docker-compose command:
